const zhCN = {
	...
	settings: {
		...
		editor: {
			...
			remoteCompletionNotice: {
				description:
					'同步设置已开启使用桌面端 AI 补全，编辑器会优先请求桌面端共享接口；本页配置作为本机回退。',
				title: '正在使用桌面端 AI 补全',
			},
			rows: {
				autoSave: {
		...
		about: {
			...
			toasts: {
				...
				latestReleaseDescription: '正在打开最新发行版页面。',
				latestReleaseTitle: '已找到最新发行版',
			},
		},
	},
	tabs: {
	...
	syncSettings: {
		...
		aiCompletion: {
			connectFirst: '连接到桌面端后，会根据桌面端共享开关启用此选项。',
			disabledOnDesktop: '桌面端尚未开启共享 AI 补全。',
			title: 'AI 补全',
			useDesktopDetail: '开启后，手机编辑器会优先使用桌面端共享的 AI 补全。',
			useDesktopTitle: '使用桌面端 AI 补全',
		},
		enable: {
			cardTitle: '同步',
			detail: '关闭后，文件树不显示远程文件夹入口。',
			title: '启用同步',
		},
		...
		errors: {
			...
			invalidManualPairing: '请输入有效的桌面端地址、端口和验证码。',
			invalidQr: '无效的配对二维码。',
			manualPairingFailed: '手动配对失败，请检查桌面端地址、端口和验证码。',
			notConnected: '尚未连接到桌面端。',
			openDatabaseFailed: '打开同步数据库失败。',
			refreshFilesFailed: '刷新远程文件失败。',
			removeTrustedFailed: '移除信任设备失败。',
			saveSettingsFailed: '保存同步设置失败。',
		...
		pairing: {
			...
			manualCode: '配对验证码',
			manualConnect: '连接',
			manualConnecting: '连接中',
			manualHost: 'IP、域名或 http(s) 地址',
			manualPort: '端口',
			manualTitle: '手动配对',
			pair: '扫码配对',
			ready: '准备配对',
