	...
	return (
		<PromptContext.Provider value={{ text, setText, handleSubmit, isDisabled }}>
			<Animated.View style={inputAnimatedStyle}>
				<View
					className="bg-muted border-border absolute bottom-4 w-full rounded-3xl
						px-3 py-2"
				>
					{children}
				</View>
...
export const PromptInputTextarea = () => {
	...
	return (
		<TextInput
			...
			multiline
			className="flex-1 text-xl px-4 items-center justify-center rounded-3xl
...
export const PromptInputSubmit = () => {
	...
	return (
		<TouchableOpacity
			...
			disabled={isDisabled}
			className={`h-10 w-10 rounded-full items-center justify-center mx-3
