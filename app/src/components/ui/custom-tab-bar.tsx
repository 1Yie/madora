...
import { useMarkdownToolbar } from '../../features/madora-sync/markdown-toolbar-context';
import type { MarkdownCompletionControl } from '../../features/madora-sync/markdown-toolbar-context';
import {
	WORKSPACE_TAB_REQUEST_EVENT,
	WORKSPACE_TAB_STATE_EVENT,
	type WorkspaceTab,
} from '../../features/madora-sync/workspace-tab-events';
			...
			>
				...
				<View
					className="max-w-[92vw] rounded-full border border-white/10
						bg-neutral-900/95 p-1 shadow-lg shadow-black/25"
				>
					<ScrollView
						horizontal
		...
		return (
			<View
				...
				className="h-11 w-11 items-center justify-center rounded-full border
					border-white/10 bg-neutral-900/95 px-3 shadow-lg shadow-black/25"
			>
	...
	if (completion.status === 'ready') {
		return (
			<Pressable
				...
				className="h-11 w-11 items-center justify-center rounded-full border
					border-white/10 bg-neutral-900/95 shadow-lg shadow-black/25"
			>
	...
	return (
		<View
			className="flex-row items-center gap-0.5 rounded-full border
				border-white/10 bg-neutral-900/95 p-1 shadow-lg shadow-black/25"
		>
			{children}
		</View>
	);
