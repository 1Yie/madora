		...
		<CommandDialogPortal {...portalProps}>
			...
			<CommandDialogViewport>
				<CommandDialogPrimitive.Popup
					className={cn(
						`relative row-start-2 flex max-h-105 min-h-0 w-full min-w-0 max-w-xl
						...
						before:bg-muted/72 before:shadow-[0_1px_--theme(--color-black/4%)]
...
export function CommandPanel({
	...
	return (
		<div
			className={cn(
				`relative -mx-px not-has-[+[data-slot=command-footer]]:-mb-px min-h-0
				rounded-t-xl not-has-[+[data-slot=command-footer]]:rounded-b-2xl border
				border-b-0 bg-popover bg-clip-padding shadow-xs/5
