	...
	return (
		<NumberFieldPrimitive.Group
			className={cn(
				...
				bg-background not-dark:bg-clip-padding text-base text-foreground
				...
				has-aria-invalid:border-destructive/36 has-autofill:bg-foreground/4
	...
	return (
		<NumberFieldPrimitive.Input
			className={cn(
				...
				outline-none [transition:background-color_5000000s_ease-in-out_0s]
				sm:h-7.5 sm:in-data-[size=lg]:h-8.5 sm:in-data-[size=sm]:h-6.5
				sm:in-data-[size=lg]:leading-8.5 sm:in-data-[size=sm]:leading-8.5
				sm:leading-7.5`,
				className
			)}
