...
export function MenuItem({
	...
	return (
		<MenuPrimitive.Item
			className={cn(
				`flex min-h-8 cursor-default select-none items-center gap-2 rounded-sm
				px-2 py-1 text-base text-foreground outline-none
	...
	return (
		<MenuPrimitive.CheckboxItem
			...
			className={cn(
				...
				text-foreground outline-none data-disabled:pointer-events-none
	...
	return (
		<MenuPrimitive.RadioItem
			className={cn(
				`grid min-h-8
				in-data-[side=none]:min-w-[calc(var(--anchor-width)+1.25rem)]
				cursor-default grid-cols-[.75rem_1fr] items-center gap-2 rounded-sm py-1
				ps-2 pe-4 text-base text-foreground outline-none
				data-disabled:pointer-events-none data-highlighted:bg-accent
				data-highlighted:text-accent-foreground data-disabled:opacity-64
	...
	return (
		<MenuPrimitive.SubmenuTrigger
			className={cn(
				...
				sm:min-h-7 sm:text-sm [&>svg:not(:last-child)]:-mx-0.5
				[&_svg:not([class*='size-'])]:size-4.5
				sm:[&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none`,
				className
			)}
