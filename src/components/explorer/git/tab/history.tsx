import { ClockIcon, CornerDownLeft, Ellipsis, RefreshCw, RotateCcw, UserIcon } from "lucide-react";
    ...
    <>
      <div className="flex shrink-0 items-center justify-between gap-3 border-b border-border p-6 pb-4">
        <div>
          ...
          <p className="mt-1 text-xs text-muted-foreground">显示当前工作区的全部提交记录。</p>
        </div>
              ...
              <div className="relative flex w-8 shrink-0 items-stretch justify-center">
                ...
                <div
                  className={cn(
                    ...
                    index === 0 ? "border-primary ring-3 ring-primary/12" : "border-primary/40",
                  )}
                />
              </div>
